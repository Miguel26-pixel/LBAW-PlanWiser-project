    ...
    <div class="navbar-align">
        <div style="display: flex; gap: 1em; align-items: center; width: 57em; justify-content: flex-start; padding-right: 80vw">
            ...
            <div class="collapse navbar-collapse navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <a class="nav-item" href="/home#aboutUs" style="width: max-content"> About Us </a>
                    <a class="nav-item" href="/home#support"> Support </a>
                    @if (Auth::check())
                    <a class="nav-item" href="{{ url('/projects') }}"> Projects </a>
        ...
        <div style="align-items: center; width: 40em; justify-content: flex-end; padding-right: 2em">
            <div class="collapse navbar-collapse navbarSupportedContent" style="justify-content: flex-end;">
                <ul class="navbar-nav">
                    <a class="nav-item" href="{{ url('/profile/'.Auth::id()) }} "> {{ Auth::user()->username }} </a>
